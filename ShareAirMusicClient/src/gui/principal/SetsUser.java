...
public class SetsUser extends Principal {
	...
	public JLabel error = new JLabel("No se puede borrar.");
	
	public SetsUser(){
		super();
		
		cabecera = new JLabel("Mis Sets");
		...
		nuevo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        		...
        		GUI.getGui().principal = new NuevoSet();
		...
		List <SetI> i = Cliente.consultarSetIsUser(Cliente.su.getUsuario().getLogin());
		lista = new ListaSets(i,true);
